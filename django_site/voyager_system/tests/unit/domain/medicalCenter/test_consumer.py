...
class TestConsumer(TestCase):
    ...
    def test_request_feedback_reminder_success(self):
        self.skipTest("method 'request_feedback_reminder' not implemented")

    # Unit Test Symbol: 1.5
    def test_request_feedback_reminder_fail(self):
        self.skipTest("method 'request_feedback_reminder' not implemented")

    # Unit Test Symbol: 1.6
    def test_provide_feedback_to_dose_success(self):
    ...
    # Unit Test Symbol: 1.6
    def test_provide_feedback_to_dose_fail_1(self):
    ...
    # Unit Test Symbol: 1.6
    def test_provide_feedback_to_dose_fail_2(self):
        print(f'Test: add feedback to dose - fail:')
