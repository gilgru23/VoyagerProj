...
class GuestService:
    ...
    def create_account(self, email: str,phone: str, f_name: str, l_name: str, dob: str) -> str:
        return SystemManagement.create_account(email, phone, f_name, l_name, dob)

    # def login(email: str, pwd: str) -> str:
    #     return SystemManagement.login(email, pwd)

    def create_consumer_profile(self, id: int, residence:str, height:int, weight:int, units: str, gender:chr, goal:any) -> str:
