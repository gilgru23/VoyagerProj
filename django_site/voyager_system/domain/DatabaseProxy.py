...
class DatabaseProxy:
    ...
    def get_account_by_email(self, email):
        return self.db.get_account_by_email(email)
    ...
    def has_account_with_email(self, email):
        return self.db.has_account_with_email(email)


    def has_account_with_id(self, account_id):
        return self.db.has_account_with_id(account_id)
    ...
    def has_consumer(self, consumer_id):
        return self.db.has_consumer(consumer_id)


    def add_consumer(self, consumer_id, residence, height, weight, units, gender, goal):
        return self.db.add_consumer(consumer_id, residence, height, weight, units, gender, goal)
    ...
    def consumer_register_dispenser(self, consumer_id, dispenser_serial_number):
        ...
        # return self.db.update_dispenser(dto)
